...
public class JFrameCadastroCarro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxTipoPneu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15", "16", "17", "18", "20", " " }));
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        meuCarro.setQuilometragem(Float.parseFloat(jFormattedTextFieldQuilometragem.getText().toString().replace("Km", "")));
        ...
        if (!jLabelID.getText().equals("")) {
            meuCarro.setId(Integer.parseInt(jLabelID.getText()));
